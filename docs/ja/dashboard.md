...
「システムダッシュボード」：システム管理者のみが設定を行えます。全ユーザーが利用可能なダッシュボードになります。  
「ユーザーダッシュボード」：システム管理者以外でも設定を行えるダッシュボードの設定です。作成したユーザーのみが利用可能なダッシュボードになります。    
...
※現在は「ガイドライン」「Exment新着情報一覧」「エディター」「HTML」が表示として可能です。
...
- [カスタムビューの「表示列選択」](/ja/view#表示列選択)に表示されている項目。選択することで、選択した列の値が、X軸に表示されます。  
...
- [カスタムビューの「表示列選択」](/ja/view#表示列選択)に表示されている項目のうち、以下の列種類。選択することで、選択した列の値が、Y軸に表示されます。
    - 整数
    - 小数
    - 通貨
...
選択することで、[カスタムビューの「グループ列選択」](/ja/table#グループ列選択)で設定した値が、X軸に表示されます。  
...
- [カスタムビューの「グループ列選択」](/ja/view#グループ列選択)に表示されている項目のうち、以下の列種類。選択することで、選択した列の値が、Y軸に表示されます。
    - 整数
    - 小数
    - 通貨
...
- [カスタムビューの「集計列選択」](/ja/view#集計列選択)に表示されている項目。選択することで、選択した列の値が、Y軸に表示されます。

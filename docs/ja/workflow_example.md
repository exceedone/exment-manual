...
- アクション「確認1」は、作成者(フローの最初の実行ユーザー)の、列「上長1」に設定されているユーザーが実行可能となる
- アクション「確認2」は、作成者(フローの最初の実行ユーザー)の、列「上長2」に設定されているユーザーが実行可能となる
...
実行前ステータス：「確認1」  
実行後ステータス：「確認2」  
実行可能ユーザー : (実行ユーザーから取得：最初の実行ユーザー)上長1  
オプション設定 > 次のステータスへ進む条件 : 「1人以上実行」  
オプション設定 > コメント : 「任意」  
オプション設定 > 特殊なアクション : チェックなし  
...
実行前ステータス：「確認2」  
実行後ステータス：「完了」  
実行可能ユーザー : (実行ユーザーから取得：最初の実行ユーザー)上長3  
オプション設定 > 次のステータスへ進む条件 : 「1人以上実行」  
オプション設定 > コメント : 「任意」  
オプション設定 > 特殊なアクション : チェックなし  
...
- アクション「確認1」は、作成者(フローの最初の実行ユーザー)の、列「上長」に設定されているユーザーが実行可能となる

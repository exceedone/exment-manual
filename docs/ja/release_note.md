...
1. 脆弱性対応
    - クロスサイトスクリプティングの脆弱性対応。詳細は[こちら](/ja/weakness/20241009)
    - 権限のないカスタムテーブルの設定変更できてしまう脆弱性対応。詳細は[こちら](/ja/weakness/20241009_2)
...
## v5.0.12 (2024/10/09)
- <span class="red bold">本件で、脆弱性対応を行っています。必ずアップデートを行っていただきますよう、よろしくお願いします。

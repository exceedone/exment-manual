...
1. 機能追加
    ...
    - プラグイン「ボタン」で、一覧画面にボタンを表示時に、一覧のチェックしたデータを取得する機能の追加(マニュアルは後日追加します)
    - プラグイン「ボタン」で、独自のボタンを表示する機能の追加(マニュアルは後日追加します)
    - テーブル毎のデータ自動共有設定で、列に設定したユーザー・組織と、データ共有設定を同期する設定の追加(マニュアルは後日追加します)

...
## v3.3.2(2020/06/25)
1. 機能追加
    - APIの「カスタムデータ検索(列指定)」にて、LIKE検索の追加。ならびに、OR検索の追加。詳細は[こちら](https://exment.net/reference/ja/webapi.html)
    - ビューを使用し、データを取得するAPIの追加。詳細は[こちら](https://exment.net/reference/ja/webapi.html)

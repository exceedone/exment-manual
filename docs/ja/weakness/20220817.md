...
- (推奨)プロジェクト全体（Exment含む）のアップロードが可能な場合：1
...
※exceedone/exmentがv5.0.3以上、ならびにexceedone/laravel-adminがv3.0.1以上に更新されます。  
※なんらかの理由で、PHP7版を現在も使用している場合でも、exceedone/exmentがv4.4.3以上、ならびにexceedone/laravel-adminがv2.2.3以上に更新されます。   

...
### 全文検索エンジン(Meilisearch)の利用
データ件数が多い環境では、部分一致検索を行うと、検索のパフォーマンスが低下する場合があります。  
その場合、全文検索エンジン「Meilisearch」を利用することで、検索を高速に行うことができます。  
詳細は[こちら](/ja/additional_meilisearch)をご確認ください。

# 役割グループ
> 本機能は、v1.Xでの「役割・権限設定」に代わって、v2.0.0より使用する機能です。

Exmentでは、システムの権限を管理するために、「役割グループ」という考え方を持ちます。  
...
以下、Exmentの「役割グループ設定」、「権限設定」について記載します。
...
### 設定の全体的な流れ
- グループ名の設定など、役割グループの初期設定を行います。
- その役割グループで実施できる権限の設定を行います。
- その役割グループに所属するユーザー・組織の設定を行います。
...
##### 権限一覧
- **システム管理** : Exmentにおけるすべての管理や操作が実行可能な権限です。  
Exment初期設定時に設定したID・パスワードのユーザーは、この「システム管理者」の役割をもちます。  
- **すべてのデータ** : すべてのカスタムテーブルの、すべてのデータの追加・編集・削除が可能な役割です。  
- **ログインユーザーの管理** : Exmentにログインするユーザーを管理できます。ログイン権限の付与や、パスワードリセットなどを行うことができます。
...
- **ビュー** : 指定したカスタムテーブルの、システムビューを管理することができます。  
...
### システム管理者グループ
Exmentのすべての機能を利用可能な、システム管理者向けの役割グループです。

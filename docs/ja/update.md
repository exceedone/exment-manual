...
- <span class="red bold">v6.X.X以下から、v7.0.0以上へのアップデートは、手動でのアップデートが必要です。Laravelのバージョン、ならびに管理画面ライブラリの名前空間が変更となります。[こちら](/ja/update/v7_0_0)の内容を一度ご確認の上、更新を行ってください。</span>

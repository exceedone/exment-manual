...
ここでは、SAMLを使用したSSOの設定方法を記載します。  


#### 注意点
- **このマニュアルでは、SAMLに詳しい方向けの手順になります。各プロバイダの設定方法などは、各資料をご参照ください。**
- このマニュアルやExmentのページでは「SAML」と記載しておりますが、実際はSAML2を使用しています。
...
- **SAML名(英数字)** : コールバックURLなどで使用するプロバイダ名です。他と重複しないように、英数字で設定を行ってください。

![ログイン設定](img/login/login_saml1.png)  

### IdP設定
IdPの設定を行ってください。
![ログイン設定](img/login/login_saml2.png)  

### SP設定
SPの設定を行ってください。
![ログイン設定](img/login/login_saml3.png)  

### オプション設定
オプション設定を行ってください。
![ログイン設定](img/login/login_saml4.png)  
...
![ログイン設定](img/login/login_saml6.png)  
...
![ログイン設定](img/login/login_saml7.png)  
...
![ログイン設定](img/login/login_saml8.png)  
...
![ログイン設定](img/login/login_saml9.png)  

![ログイン設定](img/login/login_saml10.png)  

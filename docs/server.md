...
### server
- PHP 7.2.0 or higher (Since Exment 4.X, the PHP version has changed from 7.1.3 or higher to 7.2.0 or higher)
- Laravel 6.X (Laravel version changed from 5.6 to 6.X from Exment 4.X)

...
※ In the case of a 1:N relationship (see [Relation settings in Exment](/relation)), when configuring a composite unique key for a child table, the parent table can also be selected as part of the unique key.  
